...
class NightSession:
    ...
    def __init__(self,
        ...
        self.config = Configuration(config_filenames=['nightsession.config'])
    ...
    def __repr__(self):
        return f'NightSession(utctime={self.utctime}, observer={self.observer})'
    ...
    def set_obsnight(self,
        ...
        horizon_flat = self.config.sunalt_autoflat
        horizon_startup = self.config.sunalt_startup
        horizon_observation = self.config.sunalt_observation
        horizon_shutdown = self.config.sunalt_shutdown
        obsnight = obsnight()
...
if __name__ == '__main__':
    ...
    nightsession = NightSession(observer = observer)
    print(nightsession)
# %%